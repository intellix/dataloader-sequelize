...
function shimBelongsTo(target) {
  ...
  shimmer.wrap(target, 'get', original => {
    return function batchedGetBelongsTo(instance, options = {}) {
      ...
      return Promise.resolve().then(() => {
        const foreignKeyValue = instance.get(this.foreignKey);
        ...
        if (options.raw || options.paranoid === false) {
          ...
          loader = loaders.autogenerated.get(cacheKey);
          if (!loader) {
            loader = createModelAttributeLoader(this.target, this.targetKey, { raw: options.raw, paranoid: options.paranoid, logging: options.logging });
            loaders.autogenerated.set(cacheKey, loader);
          }
        }
    ...
    return function batchedGetHasOne(instance, options = {}) {
      ...
      return Promise.resolve().then(() => {
        ...
        if (options.raw || options.paranoid === false) {
          ...
          loader = loaders.autogenerated.get(cacheKey);
          if (!loader) {
            loader = createModelAttributeLoader(this.target, this.foreignKey, { raw: options.raw, paranoid: options.paranoid, logging: options.logging });
            loaders.autogenerated.set(cacheKey, loader);
          }
        }
        return loader.load(sourceKey);
      }).then(rejectOnEmpty.bind(null, options));
    };
  });
}
